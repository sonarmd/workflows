{
  "BriteVerify": {
    ...
    "performValidation": ${BRITEVERIFY_PERFORM_VALIDATION}
  },
  "ChangeHealthcare": {
  ...
  "ChangeStreams": {
    "enabled": ${CHANGE_STREAMS_ENABLED}
  },
  "ClientFlags": {
  ...
  "Images": {
    ...
    "enableResizing": ${IMAGES_ENABLE_RESIZING},
    "maxSize": "20MB",
  ...
  "Jobs": {
    ...
    "VALIDATOR_DOCUMENT_LIMIT": ${DOCUMENT_VALIDATION_COUNT},
  ...
  "Reports": {
    ...
    "signedUrlExpiry": ${REPORTS_SIGNED_URL_EXPIRES}
  },
  "Redis": {
  ...
  "SageMaker": {
    "region": "us-east-2",
    "enrollmentEndpointName": "${SAGEMAKER_ENROLLMENT_ENDPOINT}"
  },
  "SendGrid": {
  ...
  "Slack": {
    ...
    "undeliverableMessageAlertsWebhookUrl": "${SLACK_UNDELIVERABLE_MESSAGE_ALERTS_WEBHOOK_URL}",
    "verificationToken": "${SLACK_COMMUNITY_WEBHOOK_VERIFICATION_TOKEN}"
  },
  "Twilio": {
